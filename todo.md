...
- [x] **中英文支持完善**：补全近期新增功能的中英文国际化支持。P0
- [x] **搜索入口**：在编辑模式顶部增加一个搜索入口。P0 点击之后打开相册。
应该是说输入关键词并点击搜索之后，其功能等同于相册里面的那个搜索。为了交互统一一致，也可以考虑把搜索框（不论是在编辑模式还是相册模式下）都放在正中间。原本相册中间的切换功能可以移动到一个新的位置，这样整体的交互体验会更加一致。
- [x] 把最近新更新的功能，以及最近几次提交的要点，都整理到更新文档和帮助文档中去 P0
- [x] 底部历史记录悬停时，那个“小耳朵”可以稍微强化一点，现在只有一个小箭头，视觉引导有点过于弱了 P0
...
- [ ] **顶部工具栏视觉优化**：右上角有几个图标（如“语言”等）并不需要高频切换。建议在这里增加一个菜单项，将不常用的功能折叠起来。
